...
const genaroshare_status = require('commander');
...
let address = null;
if (genaroshare_status.remote) {
  address = genaroshare_status.remote.split(':')[0];
  if (genaroshare_status.remote.split(':').length > 1) {
    port = parseInt(genaroshare_status.remote.split(':')[1], 10);
  }
}

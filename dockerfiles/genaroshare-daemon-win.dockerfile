...
ADD https://raw.githubusercontent.com/Storj/genaroshare-daemon/master/dockerfiles/get_dep_ver.ps1 get_dep_ver.ps1
...
RUN .\get_dep_ver.ps1; \
    ...
    Write-Host npm install --global genaroshare-daemon --unsafe-perm; npm install --global genaroshare-daemon --unsafe-perm; \
    ...
    Write-Host genaroshare --version; genaroshare --version;
